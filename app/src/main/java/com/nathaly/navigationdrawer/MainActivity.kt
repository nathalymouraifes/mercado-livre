package com.nathaly.navigationdrawer
...
import com.nathaly.navigationdrawer.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        when(item.itemId){
            ...
            R.id.nav_electronics -> openFragment(EletronicsFragment())
